    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <table class="table">
            ...
            <tbody>
               <?php
                  $sql = "SELECT id, nome, endereco, numero, complemento, cidade, estado, cep, datanascimento, telefone, celular, email FROM pessoas ORDER BY id";
                  $resp = mysqli_query($conexao_bd, $sql);
        ...
        <?php
        if($tipoAcesso == 1){
          echo("<a class='btn btn-lg btn-primary' href='cadastro_pessoa.php' role='button'>Novo Usuário</a>");
        }
        ?>
      </div>
    </div>
      ...
      function excluirUsuario(id){
        ...
        */
        Swal.fire({
          ...
          text: "Você deseja realmente excluir essa Pessoa?",
          icon: 'warning',
